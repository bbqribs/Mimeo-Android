...
## Multi-agent concurrency policy (Codex + Codex + humans)

- **Parallelism allowed**: Codex and Codex may both implement tickets, including code changes, in either repo.
...
- **Precedence**: AGENTS.md is authoritative for Codex behavior; CODEX_PROMPTS.md is authoritative for Codex behavior.
